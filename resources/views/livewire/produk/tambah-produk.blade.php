<div>
    <div wire:click="$emit('formClose')" class="custom-modal">
    </div>
    <div class="custom-modal-body" style="max-width: 50%;">
        <div class="card">
            <div class="card-body">
                <form wire:submit.prevent='store' class="row g-3 pt-3" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 align-self-end">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-2">
                                <button wire:click="$emit('formKategoriProdukOpen')" type="button" href=""
